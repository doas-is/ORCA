    ...
    extend: {
      colors: {
        ...
        kelp: {
          ...
          foreground: "hsl(var(--kelp-foreground))",
        },
        confidence: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsla(var(--cyan-bright), 0.3)" },
          "50%": { boxShadow: "0 0 40px hsla(var(--cyan-bright), 0.6)" },
        },
        "rotate-icon": {
      ...
      animation: {
        ...
        "bubble-rise": "bubble-rise var(--duration) linear infinite",
        "fade-in": "fade-in 0.4s ease-out",
        "fade-in-up": "fade-in-up 0.6s ease-out",
        "scale-in": "scale-in 0.3s ease-out",
        "pulse-glow": "pulse-glow 2s ease-in-out infinite",
        "rotate-icon": "rotate-icon 0.6s ease-in-out",
      },
    },
  },
